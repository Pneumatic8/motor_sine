  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const odrive_can__msg__ODriveStatus * ros_message = static_cast<const odrive_can__msg__ODriveStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_odrive_can__msg__ODriveStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  odrive_can__msg__ODriveStatus * ros_message = static_cast<odrive_can__msg__ODriveStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_odrive_can__msg__ODriveStatus(cdr, ros_message);
}
