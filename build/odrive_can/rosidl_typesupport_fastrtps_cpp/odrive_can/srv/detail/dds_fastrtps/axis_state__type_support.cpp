...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_odrive_can
max_serialized_size_key_AxisState_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_odrive_can
max_serialized_size_key_AxisState_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for odrive_can::srv::AxisState_Request already declared above

// functions for odrive_can::srv::AxisState_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_odrive_can
cdr_serialize(
  const odrive_can::srv::AxisState_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      odrive_can::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  odrive_can::srv::AxisState_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      odrive_can::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        odrive_can::srv::typesupport_fastrtps_cpp::get_serialized_size(
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_odrive_can
max_serialized_size_AxisState_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        odrive_can::srv::typesupport_fastrtps_cpp::max_serialized_size_AxisState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        odrive_can::srv::typesupport_fastrtps_cpp::max_serialized_size_AxisState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = odrive_can::srv::AxisState_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      odrive_can::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        odrive_can::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_odrive_can
max_serialized_size_key_AxisState_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        odrive_can::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AxisState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        odrive_can::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AxisState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const odrive_can::srv::AxisState_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<odrive_can::srv::AxisState_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AxisState_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const odrive_can::srv::AxisState_Event *>(
...
static size_t _AxisState_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AxisState_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AxisState_Event__callbacks = {
  "odrive_can::srv",
  "AxisState_Event",
...
static rosidl_message_type_support_t _AxisState_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AxisState_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &odrive_can::srv::typesupport_fastrtps_cpp::_AxisState_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, odrive_can, srv, AxisState_Event)() {
  return &odrive_can::srv::typesupport_fastrtps_cpp::_AxisState_Event__handle;
}
...
static const rosidl_service_type_support_t _AxisState__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AxisState__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<odrive_can::srv::AxisState_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<odrive_can::srv::AxisState_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<odrive_can::srv::AxisState_Event>(),
