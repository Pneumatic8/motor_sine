...
class Init_AxisState_Event_response
{
public:
  explicit Init_AxisState_Event_response(::odrive_can::srv::AxisState_Event & msg)
  : msg_(msg)
  {}
  ::odrive_can::srv::AxisState_Event response(::odrive_can::srv::AxisState_Event::_response_type arg)
  {
...
private:
  ::odrive_can::srv::AxisState_Event msg_;
};

class Init_AxisState_Event_request
{
public:
  explicit Init_AxisState_Event_request(::odrive_can::srv::AxisState_Event & msg)
  : msg_(msg)
  {}
  Init_AxisState_Event_response request(::odrive_can::srv::AxisState_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AxisState_Event_response(msg_);
  }
...
class Init_AxisState_Event_info
{
public:
  Init_AxisState_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AxisState_Event_request info(::odrive_can::srv::AxisState_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AxisState_Event_request(msg_);
  }
...
template<>
inline
auto build<::odrive_can::srv::AxisState_Event>()
{
  return odrive_can::srv::builder::Init_AxisState_Event_info();
}
